...
public static partial class ApplicationPartManagerExtensions
{
    ...
    private static readonly IContainerFileProvider _fileProvider;
    ...
    {
        ArgumentNullException.ThrowIfNull(CommonHelper.DefaultFileProvider, nameof(CommonHelper.DefaultFileProvider));
        ...
        var refsPathName = _fileProvider.Combine(Environment.CurrentDirectory);
